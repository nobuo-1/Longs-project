...
async function main() {
  ...
  // ── NewsQuery ─────────────────────────────────────────────────────────────────
  // 世代管理あり（queryGroupId が同じものが複数存在する）。アクティブなのは末尾4件。
  await prisma.newsQuery.createMany({
    data: [
      // ── 為替グループ (queryGroupId: ef58da79) ───────────────────────────────
      {
        id:           "ef58da79-fc1e-4ed0-b2e6-d6da1a305e6f",
        queryGroupId: "ef58da79-fc1e-4ed0-b2e6-d6da1a305e6f",
        name:         "為替",
        keywords:     "為替 円安 円高",
        language:     "ja",
        sources:      "jp.reuters.com,nhk.or.jp,xtech.nikkei.com,www.sankei.com,jiji.com",
        categoryMode: "include",
        categories:   "business,environment,world,domestic,politics",
        isActive:     false,
        createdAt:    new Date("2026-05-07T08:37:53.976Z"),
        deactivatedAt: new Date("2026-05-07T08:42:32Z"),
      },
      {
        id:           "1e01ac7f-244f-4fc0-a8f8-d71845a52282",
        queryGroupId: "ef58da79-fc1e-4ed0-b2e6-d6da1a305e6f",
        name:         "為替",
        keywords:     "為替 円安 円高",
        language:     "ja",
        ...
        categories:   null,
        isActive:     false,
        createdAt:    new Date("2026-05-07T08:42:32.196Z"),
        deactivatedAt: new Date("2026-05-07T08:44:09Z"),
      },
      {
        id:           "28f3a43a-cf81-40b8-a916-a159bc9786b7",
        queryGroupId: "ef58da79-fc1e-4ed0-b2e6-d6da1a305e6f",
        name:         "為替",
        keywords:     null,
        language:     "ja",
        sources:      "jp.reuters.com,nhk.or.jp,xtech.nikkei.com,www.sankei.com,jiji.com",
        categoryMode: "include",
        categories:   "business,politics,world,domestic",
        isActive:     true,
        createdAt:    new Date("2026-05-07T08:44:09.290Z"),
        deactivatedAt: null,
      },
      // ── 原材料グループ (queryGroupId: dbf375ce) ─────────────────────────────
      {
        id:           "dbf375ce-128d-428c-9414-e5854f6922d0",
        queryGroupId: "dbf375ce-128d-428c-9414-e5854f6922d0",
        name:         "原材料",
        keywords:     "綿 合皮 合成皮革 レーヨン ポリエステル 羊毛 ウール コットン",
        language:     "ja",
        sources:      "jp.reuters.com,nhk.or.jp,xtech.nikkei.com,www.sankei.com,jiji.com",
        categoryMode: "include",
        categories:   "business,environment,world,domestic,lifestyle",
        isActive:     false,
        createdAt:    new Date("2026-05-07T08:39:02.001Z"),
        deactivatedAt: new Date("2026-05-07T08:43:12Z"),
      },
      {
        id:           "79bcf5d9-b815-4d30-a279-329d1dde4625",
        queryGroupId: "dbf375ce-128d-428c-9414-e5854f6922d0",
        name:         "原材料",
        keywords:     "綿 合皮 合成皮革 レーヨン ポリエステル 羊毛 ウール コットン ナフサ",
        language:     "ja",
        sources:      "jp.reuters.com,nhk.or.jp,xtech.nikkei.com,www.sankei.com,jiji.com",
        categoryMode: null,
        categories:   null,
        isActive:     false,
        createdAt:    new Date("2026-05-07T08:43:12.596Z"),
        deactivatedAt: new Date("2026-05-07T09:04:21Z"),
      },
      {
        id:           "1226b89b-3248-4c10-9298-2671887ead76",
        queryGroupId: "dbf375ce-128d-428c-9414-e5854f6922d0",
        name:         "原材料",
        keywords:     "綿 合皮 合成皮革 レーヨン ポリエステル 羊毛 ウール コットン ナフサ",
        language:     "ja",
        ...
        categories:   null,
        isActive:     false,
        createdAt:    new Date("2026-05-07T09:04:21.681Z"),
        deactivatedAt: new Date("2026-05-07T09:04:39Z"),
      },
      {
        id:           "2872e5b8-65b2-46da-b7fc-c691fabfb5b0",
        queryGroupId: "dbf375ce-128d-428c-9414-e5854f6922d0",
        name:         "原材料",
        keywords:     "綿 合皮 合成皮革 レーヨン ポリエステル 羊毛 ウール コットン ナフサ",
        language:     "ja",
        ...
        categories:   null,
        isActive:     true,
        createdAt:    new Date("2026-05-07T09:04:39.363Z"),
        deactivatedAt: null,
      },
      // ── 同業他社グループ (queryGroupId: 4932502e) ───────────────────────────
      {
        id:           "4932502e-941f-4765-9bd9-a8db9fb6a775",
        queryGroupId: "4932502e-941f-4765-9bd9-a8db9fb6a775",
        name:         "同業他社",
        keywords:     "ファッション アパレル アイテム カバン バッグ かばん リュック アンダーウェア",
        language:     "ja",
        sources:      "prtimes.jp,www.businesswire.com",
        categoryMode: "include",
        categories:   "business,environment,world,domestic,lifestyle",
        isActive:     true,
        createdAt:    new Date("2026-05-07T08:40:41.411Z"),
        deactivatedAt: null,
      },
      // ── 物流・運送グループ (queryGroupId: 513187c2) ─────────────────────────
      {
        id:           "513187c2-a4a6-4679-9d26-71e756c59957",
        queryGroupId: "513187c2-a4a6-4679-9d26-71e756c59957",
        name:         "物流・運送",
        keywords:     "石油 原油 燃料 運輸 運送 物流",
        language:     "ja",
        sources:      "jp.reuters.com,nhk.or.jp,xtech.nikkei.com,sankei.com,jiji.com",
        categoryMode: null,
        categories:   null,
        isActive:     false,
        createdAt:    new Date("2026-05-07T08:47:24.701Z"),
        deactivatedAt: new Date("2026-05-07T08:58:36Z"),
      },
      {
        id:           "399cbd74-ec3e-4d9c-829e-994c0fde4a70",
        queryGroupId: "513187c2-a4a6-4679-9d26-71e756c59957",
        name:         "物流・運送",
        keywords:     "石油 原油 燃料 運輸 運送 物流",
        language:     "ja",
        ...
        categories:   null,
        isActive:     false,
        createdAt:    new Date("2026-05-07T08:58:36.479Z"),
        deactivatedAt: new Date("2026-05-07T09:03:35Z"),
      },
      {
        id:           "cc419f73-da14-4bcf-a1be-25661ed9c50a",
        queryGroupId: "513187c2-a4a6-4679-9d26-71e756c59957",
        name:         "物流・運送",
        keywords:     "石油 原油 燃料 運輸 運送 物流 ホルムズ",
        language:     "ja",
        sources:      null,
        categoryMode: null,
        categories:   null,
        isActive:     true,
        createdAt:    new Date("2026-05-07T09:03:35.030Z"),
        deactivatedAt: null,
      },
    ],
    skipDuplicates: true,
  ...
  await prisma.businessNews.createMany({
    data: [
      // ── 為替 (query: 1e01ac7f) ───────────────────────────────────────────────
      {
        id:         "4df69a03-0322-40ec-98e7-d2b1bd9a4a70",
        queryId:    "1e01ac7f-244f-4fc0-a8f8-d71845a52282",
        externalId: "83e5f5dce82775b2fa8961986432e7a9",
        title:      "NY円、157円台後半 円売りドル買い優勢に 為替介入への警戒感も",
        summary:    "5日のニューヨーク外国為替市場の円相場は午後5時現在、前日比65銭円安ドル高の1ドル=157円84~94銭を付けた。ユーロは1ユーロ=1・1688~98ドル、...",
        sourceName: "sankei",
        sourceUrl:  "https://www.sankei.com/article/20260506-IDX7GTKYIVKSRKX3P6DVA5AKWE/",
        impact:     null,
        publishedAt: new Date("2026-05-05T22:17:19Z"),
        fetchedAt:   new Date("2026-05-07T09:00:00Z"),
        weekStart:   new Date("2026-05-03"),
      },
      {
        id:         "061c0dc6-6340-4b67-8f10-0e46e4fe4788",
        queryId:    "1e01ac7f-244f-4fc0-a8f8-d71845a52282",
        externalId: "2c142d49b282ce7c3d34d35a3582faad",
        title:      "NY市場サマリー(5日)利回り低下、ドル小幅安 S&P・ナスダック最高値",
        summary:    "ホルムズ海峡を巡る米国とイランの対応を見極めようとする動きが続く中、ドルがユーロなどの主要通貨に対しやや下落した。円は日本政府・日銀による為替介入への警戒感が続く中、低調な取引を背景に対ドルで小幅に下落した。",
        sourceName: "reuters",
        sourceUrl:  "https://jp.reuters.com/markets/japan/QWOP7LAWEFKVBOKSA3CPFNOTIY-2026-05-05/",
        impact:     null,
        publishedAt: new Date("2026-05-05T21:19:09Z"),
        fetchedAt:   new Date("2026-05-07T09:00:00Z"),
        weekStart:   new Date("2026-05-03"),
      },
      {
        id:         "bdcd6127-bcd9-47d4-bf8d-ad9111adc996",
        queryId:    "1e01ac7f-244f-4fc0-a8f8-d71845a52282",
        externalId: "19f0287aeaee62da94d2314d502c125a",
        title:      "NY外為市場=ドル小幅安、円は157円台後半 介入警戒続く",
        summary:    "ニューヨーク外為市場では、ホルムズ海峡を巡る米国とイランの対応を見極めようとする動きが続く中、ドルがユーロなどの主要通貨に対しやや下落した。円は日本政府・日銀による為替介入への警戒感が続く中、低調な取引を背景に対ドルで小幅に下落した。",
        sourceName: "reuters",
        sourceUrl:  "https://jp.reuters.com/markets/japan/AF2PHM25YJLL5ERYREIBYZVVBM-2026-05-05/",
        impact:     null,
        publishedAt: new Date("2026-05-05T21:01:10Z"),
        fetchedAt:   new Date("2026-05-07T09:00:00Z"),
        weekStart:   new Date("2026-05-03"),
      },
      // ── 為替 (query: 28f3a43a, アクティブ世代) ──────────────────────────────
      {
        id:         "2a25ba2e-ff0b-440d-943e-b43d61b74b93",
        queryId:    "28f3a43a-cf81-40b8-a916-a159bc9786b7",
        externalId: "6e976cbe4466452f832501511392696a",
        title:      "アドビ、「SaaSの死」に対抗 顧客ブランド守るAIエージェント (西海岸Techトレンド)",
        summary:    "AIの進化による「SaaSの死」の懸念がデザイン分野に広がり始めた。AIエージェントの実現を目指す大手SaaS勢はどう生き残りを図るのか。米アドビの取り組みを探った。",
        sourceName: "nikkei",
        sourceUrl:  "https://business.nikkei.com/atcl/gen/19/00466/042800045/",
        impact:     null,
        publishedAt: new Date("2026-05-06T20:00:00Z"),
        fetchedAt:   new Date("2026-05-07T09:00:00Z"),
        weekStart:   new Date("2026-05-03"),
      },
      {
        id:         "871d0691-58d7-4223-8ffc-af3dae5be7dd",
        queryId:    "28f3a43a-cf81-40b8-a916-a159bc9786b7",
        externalId: "7be990b44dd33a8c6785898d3edf3f9a",
        title:      "渋谷区のマンション工事停止を仮命令 地裁決定、盛土規制法の運用にメス",
        summary:    "「渋谷区長は、モリモトに対し、本件工事の停止命令を仮にせよ」。建設中のマンションの既存擁壁解体工事を巡り、周辺住民が許認可に関わる渋谷区に工事停止の仮命令を求めた申し立てについて、東京地方裁判所はこのほど、このような趣旨の決定を下した。",
        sourceName: "nikkei",
        sourceUrl:  "https://xtech.nikkei.com/atcl/nxt/column/18/00154/02803/",
        impact:     null,
        publishedAt: new Date("2026-05-06T20:00:00Z"),
        fetchedAt:   new Date("2026-05-07T09:00:00Z"),
        weekStart:   new Date("2026-05-03"),
      ...
      {
        id:         "15a207dc-1ce0-4df4-8cd8-8d7ff013e136",
        queryId:    "28f3a43a-cf81-40b8-a916-a159bc9786b7",
        externalId: "7352186d2caded7852cb120a793c4888",
        title:      "星野リゾート代表 課題山積みだから後継者が活躍する勝ちパターン (社長の育て方)",
        summary:    "星野リゾート・星野佳路代表も注目する小さな養鶏場の快進撃。売上高を5倍にした経営改革のスタートは「できちゃった婚」。思いがけず農業に飛び込んだ娘婿が、義父が愚直につくる「おいしい卵」の拡販に奔走する。",
        sourceName: "nikkei",
        sourceUrl:  "https://business.nikkei.com/atcl/gen/19/00679/040700012/",
        impact:     null,
        publishedAt: new Date("2026-05-06T20:00:00Z"),
        fetchedAt:   new Date("2026-05-07T09:00:00Z"),
        weekStart:   new Date("2026-05-03"),
      ...
      {
        id:         "f0d0fbda-61a8-4d20-b5d0-a0f9c2435022",
        queryId:    "28f3a43a-cf81-40b8-a916-a159bc9786b7",
        externalId: "ba417cfe645f283ee5e1eda954dc684f",
        title:      "首都高社員2人が官製談合に関与、受注者側に再就職したOBへ情報漏洩",
        summary:    "首都高速道路会社発注の清掃業務で社員2人が関与する談合があったとして、公正取引委員会は官製談合防止法に基づき同社に改善措置を要求した。",
        sourceName: "nikkei",
        sourceUrl:  "https://xtech.nikkei.com/atcl/nxt/column/18/00142/02613/",
        impact:     null,
        publishedAt: new Date("2026-05-06T20:00:00Z"),
        fetchedAt:   new Date("2026-05-07T09:00:00Z"),
        weekStart:   new Date("2026-05-03"),
      ...
      {
        id:         "83c65f37-27d5-4a5f-af6e-89a0073b4c71",
        queryId:    "28f3a43a-cf81-40b8-a916-a159bc9786b7",
        externalId: "2b70eb9a69319a97498d3bb52a7cb936",
        title:      "1位は「リサイクル率97.2%の落とし穴、5年後にコンクリート塊は再生困難に」",
        summary:    "日経クロステック土木面で、過去に公開したニュースをランキング形式でご紹介します。2025年5月4~10日に読まれた記事の1~10位を26年5月7~13日に無料で読めるようにしました。",
        sourceName: "nikkei",
        sourceUrl:  "https://xtech.nikkei.com/atcl/nxt/column/18/00674/010800363/",
        impact:     null,
        publishedAt: new Date("2026-05-06T20:00:00Z"),
        fetchedAt:   new Date("2026-05-07T09:00:00Z"),
        weekStart:   new Date("2026-05-03"),
      ...
      {
        id:         "2a8e156a-ed2b-4862-b79b-e7035202df44",
        queryId:    "28f3a43a-cf81-40b8-a916-a159bc9786b7",
        externalId: "80285224a4349b9da2e4093b60f6b570",
        title:      "[クイズ]中国のレアアース埋蔵量、世界の何割? (日経ビジネス教養クイズ)",
        summary:    null,
        sourceName: "nikkei",
        sourceUrl:  "https://business.nikkei.com/atcl/gen/19/00738/042700243/",
        impact:     null,
        publishedAt: new Date("2026-05-06T20:00:00Z"),
        fetchedAt:   new Date("2026-05-07T09:00:00Z"),
        weekStart:   new Date("2026-05-03"),
      ...
      {
        id:         "91cd879a-5723-42a3-8f19-d22c2a865d81",
        queryId:    "28f3a43a-cf81-40b8-a916-a159bc9786b7",
        externalId: "2a5ecb08be813f472689002586e397d5",
        title:      "1位は「京都駅ビルへの批判に沈黙貫く、原広司の答えは『結果で証明』」",
        summary:    "日経クロステック建築面で、過去に公開したニュースをランキング形式でご紹介します。2025年5月4~10日に読まれた記事の1~10位を26年5月7~13日に無料で読めるようにしました。",
        sourceName: "nikkei",
        sourceUrl:  "https://xtech.nikkei.com/atcl/nxt/column/18/00241/010800413/",
        impact:     null,
        publishedAt: new Date("2026-05-06T20:00:00Z"),
        fetchedAt:   new Date("2026-05-07T09:00:00Z"),
        weekStart:   new Date("2026-05-03"),
      ...
      {
        id:         "75346f3d-f638-45e6-b2c9-fee220cd1352",
        queryId:    "28f3a43a-cf81-40b8-a916-a159bc9786b7",
        externalId: "7450ffc3a8f01d98f8513b8ee82846a0",
        title:      "中東危機で変わる航路、喜望峰ルートの通航2倍に コスト増もリスク軽減重視 (Business Intelligence)",
        summary:    "地政学リスクの高まりから、海運会社などがコスト重視の航路と、費用はかかるがリスクを低減できる航路のどちらを選ぶかに揺れている。",
        sourceName: "nikkei",
        sourceUrl:  "https://business.nikkei.com/atcl/gen/19/00869/043000008/",
        impact:     null,
        publishedAt: new Date("2026-05-06T20:00:00Z"),
        fetchedAt:   new Date("2026-05-07T09:00:00Z"),
        weekStart:   new Date("2026-05-03"),
      ...
      {
        id:         "53c30974-14eb-4e9d-8784-04a370032d23",
        queryId:    "28f3a43a-cf81-40b8-a916-a159bc9786b7",
        externalId: "062632e4da6a6dfe7ea0b233c8141d60",
        title:      "ハンガリー総選挙で圧勝した野党党首マジャル氏 腐敗一掃へ (世界鳥瞰)",
        summary:    "ハンガリーの総選挙で現オルバン首相の与党に圧勝した野党党首のマジャル氏は、腐敗の一掃を誓った。だがオルバン首相が16年かけて築いてきた縁故的体制は、国内制度に根深く浸透している。",
        sourceName: "nikkei",
        sourceUrl:  "https://business.nikkei.com/atcl/NBD/19/world/00794/",
        impact:     null,
        publishedAt: new Date("2026-05-06T20:00:00Z"),
        fetchedAt:   new Date("2026-05-07T09:00:00Z"),
        weekStart:   new Date("2026-05-03"),
      ...
      {
        id:         "3a40ffa8-c0d3-429d-a66f-afebc2ae895c",
        queryId:    "28f3a43a-cf81-40b8-a916-a159bc9786b7",
        externalId: "aa0c08e5d422362b48445b87eb6d3001",
        title:      "西武鉄道初のシールドトンネル掘進開始、新宿線の中井─野方間が地下へ",
        summary:    "西武新宿線の中井駅付近から野方駅付近までの東京都中野区内の約2.4kmを地下化し、7カ所の踏切を除却する連続立体交差事業が進められている。2026年5月8日にシールド機の掘進が始まるのを前に、新井薬師前駅北側の工事ヤード内で発進式が実施された。",
        sourceName: "nikkei",
        sourceUrl:  "https://xtech.nikkei.com/atcl/nxt/column/18/00110/00525/",
        impact:     null,
        publishedAt: new Date("2026-05-06T20:00:00Z"),
        fetchedAt:   new Date("2026-05-07T09:00:00Z"),
        weekStart:   new Date("2026-05-03"),
      },
      // ── 物流・運送 (query: 399cbd74) ────────────────────────────────────────
      {
        id:         "ab385e4c-a943-4178-b08a-7695011f579f",
        queryId:    "399cbd74-ec3e-4d9c-829e-994c0fde4a70",
        externalId: "1224ed8e45b9c9e1fbfc4b5787fcc009",
        title:      "原油高や異常気象が家計直撃も...今後1年で値上がり&値下がり濃厚な品目",
        summary:    "ホルムズ海峡の事実上封鎖による原油高、異常気象、さらには円安など、先行きへの不安を煽るニュースが連日飛び交っているが、結局のところ、私たちに身近な日用品や食品の価格はどう変わる可能性があるのか。",
        sourceName: "livedoor",
        sourceUrl:  "https://news.livedoor.com/article/detail/31187677/",
        impact:     null,
        publishedAt: new Date("2026-05-05T21:00:51Z"),
        fetchedAt:   new Date("2026-05-07T09:00:00Z"),
        weekStart:   new Date("2026-05-03"),
      },
    ],
  ...
  console.log("✓ BusinessNews (14件、embeddingはbackfill-embeddings.tsで別途生成)")
